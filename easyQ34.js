...
function calculateDifference(stolenItems, deduction) {
    let stolenItemsArray = Object.values(stolenItems);

    let stolenItemsTotal = 0;
    for(var i = 0; i < stolenItemsArray.length; i++) {
        stolenItemsTotal += stolenItemsArray[i];
    }

    return stolenItemsTotal - deduction;
}
